...
export default function BlogPlaceholder() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#f4f6fb] px-4 py-8 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-xl sm:rounded-[2rem] sm:p-10">
        ...
        <Link
          to="/#blog"
          className="mt-8 inline-flex items-center justify-center gap-2 rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition-all duration-200 hover:border-slate-400 hover:bg-slate-50"
        >
